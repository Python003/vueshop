    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 10, 30, 23, 40, 53, 864406), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '轮播商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 10, 30, 23, 40, 53, 862406), verbose_name='添加时间')),
            ],
        ),
        migrations.CreateModel(
            name='GoodsCategory',
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 10, 30, 23, 40, 53, 860406), verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 10, 30, 23, 40, 53, 861406), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '品牌',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.CharField(blank=True, max_length=300, null=True, verbose_name='图片url地址')),
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 10, 30, 23, 40, 53, 863406), verbose_name='添加时间')),
