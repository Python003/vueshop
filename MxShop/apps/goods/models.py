...
class GoodsCategory(models.Model):
    ...
    category_type = models.CharField(choices=CATEGORY_TYPE,max_length=30,verbose_name='类目级别',help_text='类目级别')
...
class GoodsImage(models.Model):
    ...
    image_url = models.CharField(max_length=300,null=True,blank=True,verbose_name='图片url地址')
    add_time = models.DateTimeField(default=datetime.now(),verbose_name='添加时间')
